...
import Logo from "../public/jericho.png";
					...
					<div className="flex items-center h-20 w-full">
						<div className="flex items-center  mr-20 ml-10  justify-between w-full">
							<div className="flex justify-center items-center flex-shrink-0 ">
								<Link href='/'><h1 className=" font-bold text-xl cursor-pointer">
									JerichoHub
								</h1></Link>
							</div>
							<div className="hidden md:block">
								<div className="ml-10 flex items-baseline space-x-4">
									...
									href="/about"
										...
										className="cursor-pointer hover:bg-red-600 text-white hover:text-white px-3 py-2 rounded-md text-sm font-medium"
									>
										About
									</Link>
									<Link
									...
									<Link
									href="/supportUs"
										className="cursor-pointer bg-red-600 text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-white hover:text-black"
									>
										Support Us
									</Link>
								</div>
